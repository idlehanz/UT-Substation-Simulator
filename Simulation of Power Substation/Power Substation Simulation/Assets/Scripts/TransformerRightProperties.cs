...
public class TransformerRightProperties : MonoBehaviour {
	...
	void Update () {
		GameObject br = GameObject.Find ("Breaker Right");
		BreakerRightProperties breaker = br.GetComponent<BreakerRightProperties> ();
